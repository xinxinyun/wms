...
public class MainActivity extends BaseActivity {
    ...
    private PopupMenu.MENUITEM cur_item = PopupMenu.MENUITEM.ITEM1;
    ...
    private final BroadcastReceiver mRecv = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(ReaderHelper.BROADCAST_REFRESH_FAST_SWITCH)) {
                ...
                ((VehicleApplication) getApplication()).writeMonitor((String) intent.getStringExtra("log"), intent.getIntExtra("type", ERROR.SUCCESS));
                ...
                setPositiveButton(getString(R.string.ok),
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ((VehicleApplication) getApplication()).onTerminate();
                            }
